...
\vspace{2em}
\begin{center}
\Large\textit{``We reduced our 100-dimensional portfolio to 3 principal components.\\[0.5em]
The fourth component? That's just noise\ldots\ probably.''}
\end{center}
\vspace{1em}
\begin{center}
\normalsize --- Overheard in a quantitative risk team
\end{center}
\bottomnote{Adapted from XKCD \#2400 ``Statistics'' by Randall Munroe (CC BY-NC 2.5)}
\end{frame}
