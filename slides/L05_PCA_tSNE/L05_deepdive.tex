...
\begin{frame}[t]{Perplexity Parameter}
\begin{center}
\includegraphics[width=0.65\textwidth]{04_tsne_perplexity/chart.pdf}
\end{center}
\bottomnote{Perplexity $\approx$ effective number of neighbors (try 5-50)}
\end{frame}
...
%% PART 4: COMPARISON
\begin{frame}[t]{Part 4: PCA vs t-SNE}
\begin{center}
\includegraphics[width=0.65\textwidth]{05_pca_vs_tsne/chart.pdf}
\end{center}
\bottomnote{PCA: global structure, linear. t-SNE: local structure, non-linear}
\end{frame}
...
\begin{center}
\includegraphics[width=0.65\textwidth]{06_cluster_preservation/chart.pdf}
\end{center}
\bottomnote{t-SNE often reveals cluster structure better than PCA}
\end{frame}
