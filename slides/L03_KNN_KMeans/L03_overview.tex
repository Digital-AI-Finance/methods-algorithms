...
% SLIDE 3: SCQ Opening
\begin{frame}[t]{Can a Machine Learn by Looking at Its Neighbors?}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Situation:} A bank has millions of past transactions labeled as fraud or legitimate, and millions of customers with no predefined segments.

\vspace{0.2em}
\textbf{Complication:} Traditional rule-based systems miss novel fraud patterns, and marketing teams lack data-driven customer segments.

\vspace{0.2em}
\textbf{Question:} Can we classify new transactions by similarity to past ones, and discover natural customer groups without labels?

\column{0.48\textwidth}
\vspace{-0.5em}
\begin{center}
\includegraphics[width=0.80\textwidth]{images/1838_machine_learning.png}
\end{center}
\end{columns}
\bottomnote{XKCD \#1838 by Randall Munroe (CC BY-NC 2.5) -- Today: KNN for classification, K-Means for clustering}
\end{frame}

% ============================================================================
% SLIDE 4: Classification vs Clustering
\begin{frame}[t]{What Is the Difference Between Classification and Clustering?}
...
\begin{frame}[t]{How Does KNN Draw Boundaries?}
\begin{center}
...
% ============================================================================
% SLIDE: Distance Metrics Visualization
...
\begin{compactlist}
  \item Euclidean (circle), Manhattan (diamond), and Chebyshev (square) define different neighborhoods
  \item The choice of distance metric directly shapes which points are considered nearest neighbors
\end{compactlist}

\bottomnote{Different metrics create different decision boundaries -- choose based on your data structure}
\end{frame}
...
\begin{frame}[t]{How Do We Measure Similarity?}
...
\textbf{Example:} Points $(1,2)$ and $(4,6)$: distance $= \sqrt{(4{-}1)^2 + (6{-}2)^2} = \sqrt{9+16} = 5$.
...
\begin{frame}[t]{How Does KNN Classify New Points?}
...
\begin{frame}[t]{What Does K-Means Optimize?}
...
\begin{frame}[t]{How Does K-Means Work Step by Step?}
...
\begin{frame}[t]{What Does One K-Means Iteration Look Like?}
\begin{center}
...
\begin{frame}[t]{How Do We Choose the Right K?}
\begin{center}
...
\begin{frame}[t]{How Do Banks Segment Customers?}
...
\begin{frame}[t]{Can KNN Detect Fraud?}
...
\includegraphics[width=\textwidth,height=0.60\textheight,keepaspectratio]{images/2731_kmeans_clustering.png}
