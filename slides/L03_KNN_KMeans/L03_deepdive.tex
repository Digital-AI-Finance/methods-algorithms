...
% ============================================================
\begin{frame}[t]{How Machine Learning Really Works}
\begin{center}
...
% ============================================================
\begin{frame}[t]{Distance Metrics: Visualization}
\begin{center}
...
% ============================================================
\begin{frame}[t]{Choosing K: Bias-Variance Tradeoff}
...
% ============================================================
\begin{frame}[t]{Cover \& Hart (1967): Consistency Theorem}
...
% ============================================================
\begin{frame}[t]{Cover \& Hart: Proof Sketch}
...
% ============================================================
\begin{frame}[t]{K-Means Assumptions and Failure Cases}
...
% ============================================================
\begin{frame}[t]{Computational Considerations}
\begin{center}
\begin{tabular}{lcc}
\toprule
...
% ============================================================
\begin{frame}[t]{Hopkins Statistic: Should We Cluster?}
...
% ============================================================
\begin{frame}[t]{Comparison of K Selection Methods}
\begin{center}
\begin{tabular}{lccc}
\toprule
...
% ============================================================
\begin{frame}[t]{Finance: RFM Customer Segmentation}
...
% ============================================================
\begin{frame}[t]{KNN in scikit-learn}
...
% ============================================================
\begin{frame}[t]{K-Means in scikit-learn}
\textbf{Basic Usage}
\begin{itemize}
...
% ============================================================
\begin{frame}[t]{Pipeline: Scaling + Algorithm}
