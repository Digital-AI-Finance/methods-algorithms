...
\column{0.42\textwidth}
\begin{center}
\includegraphics[width=0.80\textwidth,height=0.45\textheight,keepaspectratio]{images/1132_frequentist_bayesian.png}
\end{center}

\vspace{1mm}
\footnotesize
\fcolorbox{mlpurple}{mllavender4}{\parbox{0.85\columnwidth}{%
\textbf{Next: L03 -- KNN \& K-Means}\\
\scriptsize From parametric to non-parametric methods.
}}
\end{columns}

\bottomnote{XKCD \#1132 by Randall Munroe (CC BY-NC 2.5) | Next: L03 KNN \& K-Means}
\end{frame}
