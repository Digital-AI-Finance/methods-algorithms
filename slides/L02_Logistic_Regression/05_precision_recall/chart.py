...
CHART_METADATA = {
    ...
    "description": "PR curves for imbalanced classification",
    "url": "https://github.com/Digital-AI-Finance/methods-algorithms/tree/master/slides/L02_Logistic_Regression/05_precision_recall"
}
