...
\begin{itemize}
  \item Teaching computers to learn from data, without being explicitly programmed
  \item Everyday examples: email spam filters, Netflix recommendations, voice assistants
  \item Key idea: the computer finds patterns in data, then uses those patterns to make predictions on new data
\end{itemize}
...
\bottomnote{XKCD \#1725 by Randall Munroe (CC BY-NC 2.5) -- ML is already part of your daily life}
\end{frame}

% ============================================
% SLIDE 4: Supervised vs Unsupervised (Layout 10 -- Comparison)
% ============================================
...
% ============================================
\begin{frame}[t]{The Simplest Model}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{The Idea}
...
% ============================================
\begin{frame}[t]{Linear Regression Formula}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{The Model}
...
% ============================================
\begin{frame}[t]{Normal Equation vs Gradient Descent}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ============================================
\begin{frame}[t]{Regularization Overview}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Ridge (L2)}
\begin{itemize}
