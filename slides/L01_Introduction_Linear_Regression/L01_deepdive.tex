...
% ============================================
\begin{frame}[t]{The Gradient and Update Rule}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ============================================
\begin{frame}[t]{Learning Rate and SGD}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ============================================
\begin{frame}[t]{R-Squared and Adjusted R-Squared}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ============================================
\begin{frame}[t]{Hypothesis Testing and Confidence Intervals}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ============================================
\begin{frame}[t]{F-Test for Overall Significance}
...
% ============================================
\begin{frame}[t]{Ridge, Lasso, and Elastic Net}
\begin{columns}[T]
...
% ============================================
\begin{frame}[t]{VIF and Multicollinearity}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ============================================
\begin{frame}[t]{Train-Test Split and Cross-Validation}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Simple Split}
\begin{itemize}
