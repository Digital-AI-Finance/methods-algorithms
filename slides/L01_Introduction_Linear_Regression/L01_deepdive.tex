...
\begin{frame}[t]{Multiple Regression Surface}
  \begin{center}
    \includegraphics[width=0.65\textwidth]{02_multiple_regression_3d/chart.pdf}
  \end{center}
...
\begin{frame}[t]{Residual Analysis}
  \begin{center}
    \includegraphics[width=0.65\textwidth]{03_residual_plots/chart.pdf}
  \end{center}
...
\begin{frame}[t]{Learning Curves}
  \begin{center}
    \includegraphics[width=0.65\textwidth]{05_learning_curves/chart.pdf}
  \end{center}
...
\begin{frame}[t]{Ridge vs Lasso Comparison}
  \begin{center}
    \includegraphics[width=0.65\textwidth]{06_regularization_comparison/chart.pdf}
  \end{center}
...
\begin{frame}[t]{The Tradeoff Illustrated}
  \begin{center}
    \includegraphics[width=0.65\textwidth]{07_bias_variance/chart.pdf}
  \end{center}
...
\begin{frame}[t]{Algorithm Selection Guide}
  \begin{center}
    \includegraphics[width=0.60\textwidth]{08_decision_flowchart/chart.pdf}
  \end{center}
