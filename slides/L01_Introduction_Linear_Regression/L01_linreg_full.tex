...
$R^2 = 1 - \frac{0.6}{10} = 0.94$
\end{columns}

\bottomnote{Verify: $\hat{y}_1 = -0.5 + 1.6(1) = 1.1$, $\hat{y}_4 = -0.5 + 1.6(4) = 5.9$ -- residuals are small}
\end{frame}
...
\textbf{Textbooks}
\begin{compactlist}
\item James, Witten, Hastie, Tibshirani (2023). \textit{Introduction to Statistical Learning}, Ch.~3. Free at \texttt{statlearning.com}
