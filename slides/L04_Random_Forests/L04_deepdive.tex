...
\end{itemize}
\bottomnote{Gini impurity: the probability of misclassifying a randomly chosen sample}
\end{frame}
...
\end{itemize}
\bottomnote{This formula is the theoretical foundation for why Random Forests add feature randomization}
\end{frame}
