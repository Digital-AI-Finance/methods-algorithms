...
\vspace{0.3em}
\footnotesize
\textbf{Sample weight update:}
\[
w_i \leftarrow w_i \cdot \exp\!\bigl(\alpha_t \cdot \mathbb{1}[\text{misclassified}_i]\bigr)
\]

\begin{compactlist}
\item Correctly classified: weight unchanged
\item Misclassified: weight \highlight{increased} by $e^{\alpha_t}$
