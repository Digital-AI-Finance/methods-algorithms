...
\begin{center}
\includegraphics[width=0.6\textwidth]{01_decision_tree/chart.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{03_bootstrap/chart.pdf}
\end{center}
\bottomnote{Each tree trains on a different random sample, reducing overfitting}
\end{frame}
...
\begin{center}
\includegraphics[width=0.55\textwidth]{05_ensemble_voting/chart.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.65\textwidth]{06_bias_variance/chart.pdf}
\end{center}
