...
%% Slide 33: Walk-Forward Validation Timeline (CHART 13)
...
%% Slide 34: Trading Policy (CHART 06)
...
%% Slide 38: Decision Framework and Best Practices
\begin{frame}[t]{Decision Framework and Best Practices}
\vspace{-0.3em}
\begin{center}
\small
\begin{tabular}{l|cc}
...
\end{center}
\vspace{0.3em}
\textbf{Deepdive-Level Best Practices:}
\begin{itemize}
  \item Evaluate embedding quality via analogy task accuracy AND downstream task F1
  \item RL: compare against buy-and-hold benchmark after realistic transaction costs
  \item Always report confidence intervals (bootstrap for embeddings, multiple seeds for RL)
\end{itemize}
